      ...
      <div class="outline">
        <form action="<%=application.getContextPath()%>/guestBook/regist_action.jsp">
          ...
          <div style="margin: 30px 0px">
            ...
            <input class="registText" type="text" name="contents" id="contents" placeholder="방명록 남겨주세요" style="line-height: 100px; width: 90%; background-color: lightgray">
            <input type="submit" class="newButton registButton" value="등록">
          </div>
          ...
          %>
          <div style="margin: 30px 0px">
            <input class="registText" type="text" name="contents" id="contents" placeholder="로그인 후 이용 가능합니다" disabled style="line-height: 100px; width: 90%; background-color: lightgray">
